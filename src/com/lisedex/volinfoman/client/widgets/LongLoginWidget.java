 ...
 *
 */
public class LongLoginWidget extends Composite implements HasClickHandlers {

	private static LongLoginWidgetUiBinder uiBinder = GWT
			.create(LongLoginWidgetUiBinder.class);

	interface LongLoginWidgetUiBinder extends
			UiBinder<Widget, LongLoginWidget> {
	}
	...
	public LongLoginWidget() {
		...
		username.addKeyUpHandler(new KeyUpHandler() {
			...
			public void onKeyUp(KeyUpEvent event) {
				Log.debug("longloginwidget password keyhandler fired.  event=" + event.toDebugString());
